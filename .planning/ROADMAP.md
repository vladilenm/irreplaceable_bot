...
Plans:
- [x] 02-01-PLAN.md — RSS feed configuration (feeds.json) and fetcher service with time-window filtering
- [x] 02-02-PLAN.md — AI curator prompt file and ai.service.ts with Claude/OpenAI dual-provider support
- [x] 02-03-PLAN.md — Digest pipeline orchestrator (digest.service.ts) wiring RSS + AI with state management
