...
- [x] 07-01-retention-sweep-PLAN.md — Retention sweep impl (PRIV-03): batched DELETE LIMIT 1000 + structured pino log; replace cron stub
- [x] 07-02-migration-v3-forget-me-cleanup-PLAN.md — Migration v3 drops forgotten_users; capture handler + message-store strip isAuthorForgotten
- [x] 07-03-dead-code-cleanup-PLAN.md — Remove isThreadSummaryPublishedToday + upsertThreadTitle + stale Phase 5/7/8 comments + .env.example MESSAGE_RETENTION_DAYS 2→90
- [x] 07-04-requirements-md-summary-frontmatter-PLAN.md — REQUIREMENTS.md drift fix (MSG-04 wording, 19 checkbox flips, 18 cancelled-req removals, traceability rebuild) + 06-01/02/03 SUMMARY frontmatter requirements_completed backfill
- [x] 07-05-phase-0-ops-checklist-PLAN.md — Scaffold .planning/phases/04-message-capture-persistence/04-OPS-CHECKLIST.md (autonomous=false for operator-fill steps; closes SETUP-09 + PRIV-04 after operator execution)
